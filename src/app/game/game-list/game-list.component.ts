...
@Component({
  ...
  standalone: true,
  imports: [MatFormFieldModule, FormsModule,CommonModule, MatButtonModule, MatIconModule, MatTableModule,MatInputModule, MatSelectModule, GameItemComponent],
...
export class GameListComponent implements OnInit {
  ...
  editGame(game: Game): void {
    const dialogRef = this.dialog.open(GameEditComponent, { data: { game:game } });
